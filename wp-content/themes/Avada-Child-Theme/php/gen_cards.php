...
function gen_card($ID = null) {
	...
	?>
    <div class="shop_card_container<?php echo $extraclasses; ?>">
	    ...
	    <div class="shop_card_detail">
            ...
            <div class="shop_card_link">
            	<a role="link" href="<?php the_permalink($ID); ?>">Learn More &#8594;</a>
            </div>
        </div>
    </div>
    <?php
